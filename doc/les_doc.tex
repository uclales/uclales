...
The radiation type can be set by the variable iradtyp in the
NAMELIST file. As a default, calculations are done without
radiation (iradtyp=1). One has the option of using either
the simple radiation (iradtyp=2) of gcss intercomparison or
the full radiation (iradtyp=4) of Prescas and Stevens.
