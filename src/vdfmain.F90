...
!real(kind=jprb), dimension (:,:,:), allocatable :: pextrac
...
! print *, papm1
call vdfhghtn (pcog    , pnog    , kidia   , kfdia   , klon    , klev    , idraft   , ztmst , kstep, &
...
call vdfexcu(pnog   , kidia  , kfdia  , klon   , klev    , idraft  , ztmst  , pz0m   , &
           & phrlw  , phrsw  , &
