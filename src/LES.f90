...
!cgils         
    ...
    use modparticles, only : lpartic, lpartsgs, lpartstat, frqpartstat, avpartstat, lpartdump, lpartdumpui, frqpartdump
    ...
    namelist /model/  &
         ...
         lpartic,lpartsgs,lpartstat,frqpartstat,avpartstat,lpartdump,lpartdumpui,frqpartdump           ! Particles
