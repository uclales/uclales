...
!irina
    ...
    case('zi3_bar')
       ...
       if (itype==2) ncinfo = 'time'
    case('en_chg')
       if (itype==0) ncinfo = 'Energy gain or loss due to adv fix'
       if (itype==1) ncinfo = '%'
       if (itype==2) ncinfo = 'time'
    case('mt_chg')
       if (itype==0) ncinfo = 'Water mass gain or loss due to adv fix'
       if (itype==1) ncinfo = '%'
       if (itype==2) ncinfo = 'time'
    case('zi4_bar')
       if (itype==0) ncinfo = 'Height of zero level set'
       if (itype==1) ncinfo = 'm'
       if (itype==2) ncinfo = 'time'
    case('vtke')
       if (itype==0) ncinfo = 'Vertical integral of total TKE'
       if (itype==1) ncinfo = 'kg/s2'
       if (itype==2) ncinfo = 'time'
!irina       
    case('tkeint')
    ...
    case('lhf_bar')
       ...
       if (itype==2) ncinfo = 'time'
    case('zi_bar')
       if (itype==0) ncinfo = 'Height of q = 8 g/kg'
       if (itype==1) ncinfo = 'm'
       if (itype==2) ncinfo = 'time'
    case('lwp_bar')
